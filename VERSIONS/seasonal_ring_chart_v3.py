...
def draw_radial_rings(
    ...
    for i, year in enumerate(years_sorted):
        ...
        for month in range(1, 13):
            ...
            wedge = Wedge(center=(0, 0), r=r_out, theta1=theta1, theta2=theta2,
                          width=ring_width, facecolor=color, edgecolor='white', linewidth=0.5)
            ax.add_patch(wedge)
        ...
        if show_year_labels and (step is not None) and (i % step == 0):
            ...
            ax.text(x, y, str(year), va='center', ha='center', fontsize=year_label_fontsize)
    ...
    ax.plot([x1, x2], [y1, y2], color='black', linewidth=0.6, zorder=50)
        ...
        for i, year in enumerate(years_sorted):
            ...
            if label_this:
                ...
                ax.plot([px - dx, px + dx], [py - dy, py + dy],
                        color='black', linewidth=0.6, zorder=50)
